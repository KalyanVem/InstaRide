...
<body>
	<form method="post" action="Locate" enctype="multipart/form-data" id="signup-form" class="row">
		<div id="side" class="col-md-6 visible-md visible-lg">
			<h1>InstaRide</h1>
			<span>Sign Up - Provider</span>
		</div>
		<div class="col-md-6" id="main-content">
			<div class="col-md-6 visible-sm visible-xs" id="brand-sm">
				<h1>InstaRide</h1>
				<span>SignUp - Provider</span>
			</div>
